...
import HeroSectionHome3 from '@/components/home3/HeroSection';
...
// (video inset to the right 80% on lg+). Kept out of the index: it
// duplicates the homepage's content, and it isn't in app/sitemap.js either.
// `robots` overwrites the value inherited from app/layout.js rather than
// merging with it.
export const metadata = {
  title: 'HRS — Homepage variant 3',
  robots: {
    index: false,
    follow: false,
